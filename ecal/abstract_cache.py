...
class AbstractCache(object):
    ...
    def fetch_calendar(self, start_date_str, end_date_str=None):
        ...
        Args:
            ...
            end_date_str (str): The end date of the earnings calendar in the format ``YYYY-MM-DD``.
                If left out, we will fetch only the announcements for the start date.

        Returns:
            DataFrame: Returns a pandas DataFrame indexed by 'date', that has columns: 'ticker', and 'when'.
